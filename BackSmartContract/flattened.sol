...
contract dNFT is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    
    event Atransfer( address indexed from, address indexed to, uint256 indexed tokenId);
    ...
    function safeMint(address to, string memory uri) public onlyOwner {
        ...
        emit Atransfer(address(0), to, tokenId);
    }

    //Actualizar
    function update_dNFT(address _to, uint256 _tokenId, string memory _newUri ) public {

        // Update the URI
        _setTokenURI(_tokenId, _newUri);
        emit Atransfer(address(0), _to, _tokenId);
